...
import '@smyd/app-imgs/app-carousel.js';
import '@polymer/iron-image/iron-image.js';
import '@polymer/paper-icon-button/paper-icon-button.js';


class ASGShopCardDetailCarousel extends AppElement {
  ...
  async __carouselShowDotsChanged(bool) {
    if (bool) {
      ...
      this._dots.style.transition = 
        'transform 0.5s var(--app-ease, cubic-bezier(0.49, 0.01, 0, 1)), opacity 0.2s ease-in';
    }
  }
